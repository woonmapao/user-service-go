...
func AddUser(user *models.UserRequest, tx *gorm.DB) error {
...
func UpdateUser(user *models.UserRequest, tx *gorm.DB) error {

	updating := models.User{
		Username: user.Username,
		Email:    user.Email,
		Password: user.Password,
	}
...
func GetUser(id int, db *gorm.DB) (*models.User, error) {
